...
test("correct task should be deleted from correct array", () => {
  ...
  const action = tasksThunks.removeTask.fulfilled(payload, "todolistId", payload)
...
test("correct task should be added to correct array", () => {
  ...
  const action = tasksThunks.addTask.fulfilled({ task: task }, "requestId", {
    title: task.title,
...
test("status of specified task should be changed", () => {
  ...
  const action = tasksThunks.updateTask.fulfilled(payload, "todolistId", payload)
...
test("new array should be added when new todolist is added", () => {
  ...
  const action = todosThunks.addTodolist.fulfilled({ todolist }, "requestId", todolist.title)
...
test("property with todolistId should be deleted", () => {
  ...
  const action = todosThunks.removeTodolist.fulfilled({ id }, "requestId", id)
...
test("empty arrays should be added when we set todolists", () => {
  ...
  const action = todosThunks.fetchTodolists.fulfilled(payload, "todolistId")
