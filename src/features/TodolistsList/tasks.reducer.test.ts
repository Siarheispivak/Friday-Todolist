...
import {todolistActions, todosThunks} from "features/TodolistsList/todolists.reducer"
...
test("correct task should be deleted from correct array", () => {
    ...
    const action =
        tasksThunks.removeTask.fulfilled(payload,'todolistId',payload)
...
test("status of specified task should be changed", () => {
    ...
    const action =
        tasksThunks.updateTask.fulfilled(payload, "todolistId", payload)
